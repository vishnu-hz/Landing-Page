...
const TypingAnimation = () => {
  ...
  return (
    <div className='bg-white rounded-[80px] border-[1.5px] border-[#E5E5E5] shadow-home-screen flex items-center mt-6 sm:mt-[88px] mx-4 sm:mx-auto mb-6 sm:mb-[118px] w-full sm:w-[692px] h-[64px] sm:h-[82px]'>
      ...
      <div className="mr-[12px] sm:mr-[12.99px] h-[32px] sm:h-auto flex items-center">
        <SearchIcon />
      </div>
    </div>
  );
